...
constexpr size_t RULE_COUNT = 21;
constexpr std::array<IndicationRule_t, RULE_COUNT> BASE_RULES = {{
  ...
  { INDICATION_RESTRICTING,           SignalMast::DIVMASK_NOT_DIVERGING, ASPECT_FL_RED,    ASPECT_RED,       ASPECT_RED       },
  ...
  { INDICATION_STOP,                  SignalMast::DIVMASK_DIV_SLOW_SPD,  ASPECT_RED,       ASPECT_RED,       ASPECT_RED       },
  { INDICATION_RESTRICTING,           SignalMast::DIVMASK_DIV_SLOW_SPD,  ASPECT_RED,       ASPECT_RED,       ASPECT_FL_RED    },
  { INDICATION_APPROACH,              SignalMast::DIVMASK_DIV_SLOW_SPD,  ASPECT_RED,       ASPECT_RED,       ASPECT_YELLOW    },
  { INDICATION_APPROACH_DIVERGING,    SignalMast::DIVMASK_DIV_SLOW_SPD,  ASPECT_RED,       ASPECT_RED,       ASPECT_YELLOW    },
  ...
  { INDICATION_STOP,                  SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_RED,       ASPECT_RED       },
  { INDICATION_RESTRICTING,           SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_FL_RED,    ASPECT_RED       },
  { INDICATION_APPROACH,              SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_YELLOW,    ASPECT_RED       },
  { INDICATION_APPROACH_DIVERGING,    SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_YELLOW,    ASPECT_RED       },
  { INDICATION_ADVANCE_APPROACH,      SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_FL_YELLOW, ASPECT_RED       },
  { INDICATION_APPROACH_DIVERGING_AA, SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_FL_YELLOW, ASPECT_RED       },
  { INDICATION_CLEAR,                 SignalMast::DIVMASK_DIV_NO_SLOW,   ASPECT_RED,       ASPECT_GREEN,     ASPECT_RED       }
}};
