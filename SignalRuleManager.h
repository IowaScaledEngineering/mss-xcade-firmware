...
constexpr std::array<IndicationRule_t, RULE_COUNT> BASE_RULES = {{
  ...
  { INDICATION_RESTRICTING,           SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_RED,       ASPECT_FL_RED,    ASPECT_RED },
  { INDICATION_APPROACH,              SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_RED,       ASPECT_YELLOW,    ASPECT_RED },
  { INDICATION_APPROACH_DIVERGING,    SignalMast::DIVMASK_ALL_DIVERGING, ASPECT_RED,       ASPECT_YELLOW,    ASPECT_RED },
